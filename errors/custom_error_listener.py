...
class SaltinoErrorListener(ErrorListener):
    ...
    def syntaxError(self, recognizer, offendingSymbol, line, column, msg, e):
        ...
        error_msg = self._format_error_message(recognizer, offendingSymbol, line, column, msg)
    ...
    def _format_parser_error(self, msg, offending_symbol):
        ...
        if "missing" in msg.lower():
            if "'def'" in msg:
                ...
                return f"Manca il punto e virgola ';'"
            elif "'}'" in msg:
    ...
    def print_errors(self):
        ...
        for error in self.errors:
            print(f"Errore alla riga {error['line']}, colonna {error['column']}: {error['message']}")
